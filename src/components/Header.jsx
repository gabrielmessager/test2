                    ...
                    <div className="row header__row">
                        ...
                        <div className="header__grid-container">
                            <Link to="/products" className="header__grid">
                                ...
                                <img src={HomeImg1} alt="" className="header__grid__image"/>
                            </Link>
                            <Link to="/products" className="header__grid">
                                <h2 className="header__grid__title">Skin Care</h2>
                                <img src={HomeImg2} alt="" className="header__grid__image"/>
                            </Link>
                            <Link to="/products" className="header__grid">
                                <h2 className="header__grid__title">Kitchen</h2>
                                <img src={HomeImg3} alt="" className="header__grid__image"/>
                            </Link>
                            <Link to="/products" className="header__grid">
                                <h2 className="header__grid__title">Electronics</h2>
                                <img src={HomeImg4} alt="" className="header__grid__image"/>
                            </Link>
                        </div>
                    </div>
                </div>
